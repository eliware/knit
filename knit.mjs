...
import { defaultTargetLoader } from './src/targetLoader.mjs';
...
export async function main() {
  ...
  if (!await defaultTargetLoader.validateAll()) throw new Error('Knit target configuration validation failed');
